...
namespace Entity.Proxies.modifica_ProxyGenerator_test
{
    ...
    public abstract class test_ProxyGenerator_modifica_
    {


        public static int _ProxyGenerator_modifica_(
			double un_razionale,
			Int32 un_intero,
		...
		)
		{
			...
			if(  !double.IsNaN(un_razionale)  && !double.IsInfinity(un_razionale) )
			{
