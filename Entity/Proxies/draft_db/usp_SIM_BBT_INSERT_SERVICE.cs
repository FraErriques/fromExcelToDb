...
namespace Entity.Proxies.draft_db
{
    ...
    public abstract class usp_draft_db_SIM_BBT_INSERT_SERVICE
    {


        public static int usp_SIM_BBT_INSERT(
			string beneficiario,
			string servizio,
			string numero,
			string PIN,
		...
		)
		{
            ...
            cmd.CommandText = "usp_SIM_BBT_INSERT";
            //
            ...
            catch (Exception ex)
            {
                ...
                writingSucceeded =
                    LoggingToolsContainerNamespace.LoggingToolsContainer.DecideAndLog(
                        ex,
                        "eccezione in DataAccess::usp_SIM_BBT_INSERT_SERVICE : " + ex.Message,
						0 // verbosity
                );
                //
            }// end catch
