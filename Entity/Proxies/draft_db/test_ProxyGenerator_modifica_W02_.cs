...
namespace Entity.Proxies.modifica_ProxyGenerator_test
{


    public abstract class test_ProxyGenerator_modifica_W02_
    {


        public static int ProxyGenerator_modifica_W02_(
			float un_razionale,
			Int32 un_intero,
		...
		)
		{
            ...
            parun_razionale.DbType = DbType.Single;
            parun_razionale.ParameterName = "@un_razionale";
			cmd.Parameters.Add( parun_razionale);// add to command
			if(  !float.IsNaN(un_razionale)  && !float.IsInfinity(un_razionale) )
			{
            ...
            parun_intero.DbType = DbType.Int32;
			...
			if( System.DateTime.MinValue<una_data_senzaOra )
			{
