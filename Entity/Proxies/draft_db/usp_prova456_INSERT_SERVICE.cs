...
namespace Entity.Proxies.draft_db
{


    public abstract class usp_draft_db_prova456_INSERT_SERVICE
    {
		...
		)
		{
            ...
            if (Int32.MinValue < un_intero//########################################---NB. manually modified!---------########################################################
                && Int32.MaxValue > un_intero)
            {
