...
namespace Entity.Proxies
{
    ...
    public abstract class usp_Panda_FR937FT_INSERT_SERVICE
    {


        public static int usp_Panda_FR937FT_INSERT(
			string Vettura,
		...
		)
		{
            ...
            cmd.CommandText = "usp_Panda_FR937FT_INSERT";
            //
			...
			if( double.MinValue!=litri && double.MaxValue!=litri && double.NaN!=litri && double.PositiveInfinity!=litri )
			{
			...
			if( double.MinValue!=euro && double.MaxValue!=euro && double.NaN!=euro && double.PositiveInfinity!=euro )
			{
			...
			if( double.MinValue!=gasolio_euro_litro && double.MaxValue!=gasolio_euro_litro && double.NaN!=gasolio_euro_litro && double.PositiveInfinity!=gasolio_euro_litro )
			{
            ...
            catch (Exception ex)
            {
                ...
                writingSucceeded =
                    LoggingToolsContainerNamespace.LoggingToolsContainer.DecideAndLog(
                        ex,
                        "eccezione in DataAccess::usp_Panda_FR937FT_INSERT_SERVICE : " + ex.Message,
						0 // verbosity
                );
                //
            }// end catch
