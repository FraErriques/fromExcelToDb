...
namespace Entity.Proxies
{
    ...
    public abstract class usp_SIMTIMnonAttiveInBBT_LOAD_SERVICE
    {


        public static System.Data.DataTable usp_SIMTIMnonAttiveInBBT_LOAD(
		//
		)
		{
            //
            ...
            cmd.CommandText = "usp_SIMTIMnonAttiveInBBT_LOAD";
            //
            ...
            catch (Exception ex)
            {
                ...
                LoggingToolsContainerNamespace.LoggingToolsContainer.DecideAndLog(
					ex,
					"eccezione in DataAccess::usp_SIMTIMnonAttiveInBBT_LOAD_SERVICE : " + ex.Message,
                    0 // verbosity
                );
                //
            }// end catch
