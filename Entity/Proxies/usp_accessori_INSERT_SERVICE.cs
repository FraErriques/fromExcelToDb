...
namespace Entity.Proxies
{
    ...
    public abstract class usp_accessori_INSERT_SERVICE
    {


        public static int usp_accessori_INSERT(
			string beneficiario,
			string oggetto,
			string matricola,
			string note,
		...
		)
		{
            ...
            cmd.CommandText = "usp_accessori_INSERT";
            //
            ...
            catch (Exception ex)
            {
                ...
                writingSucceeded =
                    LoggingToolsContainerNamespace.LoggingToolsContainer.DecideAndLog(
                        ex,
                        "eccezione in DataAccess::usp_accessori_INSERT_SERVICE : " + ex.Message,
						0 // verbosity
                );
                //
            }// end catch
