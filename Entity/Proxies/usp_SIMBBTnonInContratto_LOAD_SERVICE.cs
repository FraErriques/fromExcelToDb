...
namespace Entity.Proxies
{
    ...
    public abstract class usp_SIMBBTnonInContratto_LOAD_SERVICE
    {


        public static System.Data.DataTable usp_SIMBBTnonInContratto_LOAD(
		//
		)
		{
            //
            ...
            cmd.CommandText = "usp_SIMBBTnonInContratto_LOAD";
            //
            ...
            catch (Exception ex)
            {
                ...
                LoggingToolsContainerNamespace.LoggingToolsContainer.DecideAndLog(
					ex,
					"eccezione in DataAccess::usp_SIMBBTnonInContratto_LOAD_SERVICE : " + ex.Message,
                    0 // verbosity
                );
                //
            }// end catch
