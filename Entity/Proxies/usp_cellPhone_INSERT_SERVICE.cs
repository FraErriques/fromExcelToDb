...
namespace Entity.Proxies
{
    ...
    public abstract class usp_cellPhone_INSERT_SERVICE
    {


        public static int usp_cellPhone_INSERT(
			string beneficiario,
			string oggetto,
			string matricola,
			string note,
		...
		)
		{
            ...
            cmd.CommandText = "usp_cellPhone_INSERT";
            //
            ...
            catch (Exception ex)
            {
                ...
                writingSucceeded =
                    LoggingToolsContainerNamespace.LoggingToolsContainer.DecideAndLog(
                        ex,
                        "eccezione in DataAccess::usp_cellPhone_INSERT_SERVICE : " + ex.Message,
						0 // verbosity
                );
                //
            }// end catch
