...
namespace Entity.Proxies
{
    ...
    public abstract class usp_getCardSIMBBTnonInContratto_READ_SERVICE
    {


        public static System.Data.DataTable usp_getCardSIMBBTnonInContratto_READ(
		//
		)
		{
            //
            ...
            cmd.CommandText = "usp_getCardSIMBBTnonInContratto_READ";
            //
            ...
            catch (Exception ex)
            {
                ...
                LoggingToolsContainerNamespace.LoggingToolsContainer.DecideAndLog(
					ex,
					"eccezione in DataAccess::usp_getCardSIMBBTnonInContratto_READ_SERVICE : " + ex.Message,
                    0 // verbosity
                );
                //
            }// end catch
