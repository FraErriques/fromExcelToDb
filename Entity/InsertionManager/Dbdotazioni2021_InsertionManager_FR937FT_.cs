...
namespace Entity.InsertionManager
{
    ...
    /// 
    /// </summary>
    public class Dbdotazioni2021_InsertionManager_FR937FT_
    {
        // data
        ...
        public Dbdotazioni2021_InsertionManager_FR937FT_( string fullPath )
        {
        ...
        /// Dtor
        /// </summary>
        ~Dbdotazioni2021_InsertionManager_FR937FT_()
        {
        ...
        {//
            ...
            {
                this.curRowSplitted = this.txtParser.rowSplitter(this.allRows[d]);// get all columns of a single row, by means of this.rowSplitter(
                Entity.Entities.Dbdotazioni2021_EntityPanda_FR937FT currentRow = new Entities.Dbdotazioni2021_EntityPanda_FR937FT( this.curRowSplitted);
                // NB. currentRow private fields, with public readers.-------##################################################
                insertionResultOnCurRow =
                    Entity.Proxies.usp_Panda_FR937FT_INSERT_SERVICE.usp_Panda_FR937FT_INSERT(
                        // id identity
